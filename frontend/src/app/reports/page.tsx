...
import { Download, Search, FileText, ExternalLink, Globe } from "lucide-react";
...
export default function ReportsPage() {
  ...
  const [weekReferenceMs] = useState(() => Date.now());
  ...
  const thisWeek = reports.filter((item) => {
    ...
    const weekAgo = weekReferenceMs - 7 * 24 * 60 * 60 * 1000;
