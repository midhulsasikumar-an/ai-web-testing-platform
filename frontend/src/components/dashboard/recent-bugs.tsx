          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-slate-50/60">
                ...
                <TableHead className="w-[100px] text-xs font-semibold">Health</TableHead>
                <TableHead className="w-[120px] text-xs font-semibold">Test Type</TableHead>
                <TableHead className="w-[140px] text-right text-xs font-semibold">Date</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {recent.length === 0 ? (
                ...
                recent.map((test) => (
                  ...
                  >
                    ...
                    <TableCell className="max-w-[250px] truncate text-xs text-muted-foreground">{test.url}</TableCell>
                    <TableCell>
                      <span
                    ...
                    <TableCell>
                      <span className="text-sm font-medium">{test.health_score ?? 0}/100</span>
                    </TableCell>
                    <TableCell className="capitalize">{test.test_type ?? "full"}</TableCell>
                    <TableCell className="text-right text-xs text-muted-foreground">{formatDate(test.date ?? "")}</TableCell>
                  </TableRow>
                ))
              )}
            </TableBody>
